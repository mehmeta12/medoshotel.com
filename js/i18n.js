...
(function () {
  ...
  const T = {
    tr: {
      ...
      'hero.title': 'Güzelçamlı\'da Ege Tatili – Medos Beach Hotel',
    ...
    en: {
      ...
      'hero.title': 'Aegean Holiday in Güzelçamlı – Medos Beach Hotel',

      /* ── Index: About ── */
      'about.label': 'Who We Are',
      'about.title': 'Beachfront Family Hotel in Güzelçamlı',
      'about.p1': 'Located in Güzelçamlı, the jewel of Kuşadası, on the Aegean coast, Medos Beach Hotel offers guests an unforgettable holiday experience with its beachfront location, nature-immersed atmosphere and comfortable facilities. An ideal choice for those looking for a hotel in Güzelçamlı, our hotel is ready to welcome guests year-round with <strong>49 rooms and 150 beds</strong> capacity, for both relaxation and exploration.',
      'about.p2': 'Medos Beach Hotel, located in Güzelçamlı, one of Kuşadası\'s most peaceful areas, is just 2 km from <a href="dilek_yarim_adasi_milli_park.html">Dilek Peninsula National Park</a>. From our hotel you can quickly discover the park\'s unique coves, join nature walks, or enjoy swimming in the crystal-clear waters on <a href="kusadasi-tekne-turlari-rehberi.html">boat tours</a>. Surrounded by the natural beauty of Güzelçamlı, you can enjoy a peaceful holiday while easily reaching Kuşadası\'s vibrant centre and nearby historical sites.',
      'about.p3': 'Standing out among <a href="guzelcamli-otel.html">accommodation options in Kuşadası Güzelçamlı</a> for its tranquillity, clean beach and family-friendly character, Medos Beach Hotel caters to guests of all ages with its comfortable rooms featuring modern design. From our French-balcony rooms you can watch the Aegean sunrise, and enjoy the sea at our private jetty just 50 metres from the hotel. Our hotel brings together peace, comfort and location advantages for guests seeking a beachfront hotel in Kuşadası.',
      'about.p4': 'Medos Beach Hotel, standing out among Kuşadası Güzelçamlı hotel options, promises not just accommodation but a holistic holiday experience combining nature, sea, discovery and relaxation. If you are looking for a beachfront, comfortable and enjoyable hotel in Güzelçamlı, you can <a href="booking.html">browse our room options</a> or contact us at <a href="tel:+902566450740">+90 256 645 07 40</a>.',
      ...
      'page.standart.f4': 'Flat Screen TV',
      ...
      'blog.by': 'Medos Hotel',
      'blog.related.title': 'Related Pages',
      'blog.related.guzelcamli': 'Stay in Güzelçamlı',
      ...
      'blog.tekne.title': 'Kuşadası Boat Tours Guide',
      'blog.tekne.date': 'April 18, 2026',
      'blog.tekne.category': 'Activity Guide',
      'blog.tekne.excerpt': 'Discover boat tours, one of Kuşadası\'s most enjoyable holiday activities. Güzelçamlı departures, hidden coves and breathtaking Aegean views.',
      'blog.tekne.cta': 'You can easily join boat tours directly from our hotel.',
      'blog.tekne.body': '<p>Kuşadası boat tours are among the most enjoyable activities of a summer holiday. Tours planned from around Güzelçamlı stand out in particular, offering faster access to coves and a more natural route experience. For guests staying at <a href="index.html">Medos Hotel</a>, this experience can be one of the unforgettable parts of the holiday.</p><h2>What to do on a Kuşadası boat tour?</h2><p>Boat tours typically include swimming stops at different coves, enjoying the sea and sun throughout the day. Some routes also offer opportunities for sightseeing, photography, and relaxing in tranquil coves.</p><h2>Coves and sea experience</h2><img src="img/kusadasi-tekne-turu-koy.jpg" alt="Kuşadası boat tour cove and turquoise sea view" loading="lazy" width="1200" height="800"><p>The most important detail that makes a boat tour special is the ability to see coves that are difficult to reach by land. For this reason, it is a very strong alternative for those who want to explore the region from the sea.</p><h2>Why are swimming stops so popular?</h2><img src="img/tekne-turu-yuzme-molasi.jpg" alt="Kuşadası boat tour swimming stop" loading="lazy" width="1200" height="800"><p>Swimming stops in coves with clean and clear water become one of the most enjoyable moments of the holiday, especially on hot summer days. It is also a very attractive activity for families with children and couples.</p><h2>Where is it more advantageous to stay for a boat tour?</h2><p>Staying in an area close to the boat tour provides convenience in terms of planning. That is why <a href="guzelcamli-otel.html">Medos Hotel in Güzelçamlı</a> stands out especially in summer. The area is also quite suitable for guests looking for a <a href="kusadasi-denize-sifir-otel.html">beachfront hotel</a>.</p>',

      'blog.dilek.title': 'Dilek Peninsula National Park Guide',
      'blog.dilek.date': 'April 18, 2026',
      'blog.dilek.category': 'Nature Guide',
      'blog.dilek.excerpt': 'Dilek Peninsula National Park guide: coves, hiking trails, nature and visit tips. Comprehensive information for guests staying in Güzelçamlı.',
      'blog.dilek.cta': 'Medos Beach Hotel\'s location, just minutes from the national park, gives you a real advantage.',
      'blog.dilek.body': '<p>Dilek Peninsula National Park is one of Güzelçamlı\'s most important natural assets. With its crystal-clear coves, rich vegetation and hiking areas, it ranks among the region\'s most remarkable routes. For guests staying at <a href="index.html">Medos Hotel</a>, a visit to the national park can be one of the most enjoyable parts of their holiday.</p><h2>Why is Dilek Peninsula so special?</h2><p>The national park is uniquely special as it brings together the sea, forest and wildlife in one location. If you don\'t want to limit your Güzelçamlı holiday to just the beach, this park is a must on your list.</p><h2>The most popular coves</h2><img src="img/dilek-yarimadasi-koylar.jpg" alt="Dilek Peninsula turquoise coves" loading="lazy" width="780" height="439"><p>The coves within the park stand out especially for their clean water and natural appearance. They are very popular with day-trippers during the summer season. Arriving in the morning hours generally provides a more relaxed experience.</p><h2>Hiking and nature experience</h2><img src="img/dilek-yarimadasi-yuruyus-rotasi.jpg" alt="Dilek Peninsula hiking trail and nature path" loading="lazy" width="780" height="439"><p>For nature hiking enthusiasts, the park offers a truly satisfying experience. It is a region rich in both scenery and wildlife. Guests staying in Güzelçamlı can plan their day with a balanced mix of sea and nature.</p><h2>Where is the best place to stay for a national park visit?</h2><p>Staying close to the national park provides a great advantage. For those who want to set off early in the morning, <a href="guzelcamli-otel.html">Medos Hotel in Güzelçamlı</a> is the far more sensible option. This area is also a very strong choice for guests looking for a <a href="kusadasi-denize-sifir-otel.html">beachfront hotel</a>.</p>',

      'blog.kusadasi.excerpt': 'Discover places to visit in Kuşadası. An up-to-date travel guide to Dilek Peninsula National Park, Zeus Cave, Pigeon Island Castle and more.',
      'blog.kusadasi.body': '<p>Kuşadası is one of the Aegean\'s most beloved holiday destinations, with its sea, historical sites and natural beauty. For guests who want to do more than swim during their holiday, there are many great alternatives. Staying at <a href="index.html">Medos Hotel</a>, you can experience the tranquil atmosphere of Güzelçamlı while easily reaching the important sights around Kuşadası.</p><h2>What are the main places to visit in Kuşadası?</h2><p>The main places to visit in Kuşadası are Dilek Peninsula National Park, Zeus Cave, Pigeon Island Castle, Şirince Village and the historical sites around Ephesus. Güzelçamlı and its surroundings are a particularly strong option for visitors seeking nature and tranquillity.</p><h2><a href="dilek_yarim_adasi_milli_park.html">Dilek Peninsula National Park</a></h2><p>One of the region\'s most striking natural areas, the Dilek Peninsula stands out with its crystal-clear coves and nature hiking opportunities. Guests staying in Güzelçamlı will find it very easy to reach. For more details, see our <a href="dilek-yarimadasi-milli-park-rehberi.html">Dilek Peninsula guide</a>.</p><h2><a href="guvercin_ada_kalesi.html">Pigeon Island Castle</a></h2><img src="img/guvercinada-kalesi-kusadasi.jpg" alt="Kuşadası Pigeon Island Castle view" loading="lazy" width="780" height="439"><p>Located in the centre of Kuşadası, Pigeon Island is well worth a visit for both its history and its views. It is particularly impressive in the evening hours.</p><h2><a href="zeus_magarasi.html">Zeus Cave</a></h2><img src="img/zeus-magarasi-kusadasi.jpg" alt="Blue water view inside Zeus Cave" loading="lazy" width="780" height="439"><p>Zeus Cave attracts great interest especially in summer with its cool water and natural atmosphere. It is also a popular short stop for visitors exploring the national park area.</p><h2>Why is Güzelçamlı the right base?</h2><p>For those who want to explore Kuşadası without being in the middle of the crowds, Güzelçamlı is a well-balanced choice. It offers proximity to nature, the sea, and a calmer atmosphere. Medos Hotel is therefore a strong option for guests looking to <a href="guzelcamli-otel.html">stay in Güzelçamlı</a>.</p>',
    },
  };
