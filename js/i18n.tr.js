...
window._T_tr = {
  ...
  'footer.developer': '<a href="https://decigent.com" target="_blank" rel="noopener noreferrer">Decigent Yapay Zeka ve Bilgi Teknolojileri</a> tarafından tasarlanmış ve geliştirilmiştir.',
  ...
  'reviews.r1.text': 'Medos Hotel mükemmel bir konumda. Odalar çok temiz, personel ilgili ve İskele Kafe özellikle gün batımında inanılmaz güzel. Gitmek istemedim, her şey için çok teşekkürler Medos Hotel.',
  'reviews.source': 'TripAdvisor',
  'reviews.r2.text': 'Personel çok ilgiliydi — odamı tam deniz manzaralı bir odayla değiştirdiler. Havuz alanı güneş şezlongu ve bar ile çok güzel. Kahvaltı Türk usulü ve bolca seçenekle geldi. Kesinlikle tekrar geleceğim.',
  'reviews.r3.text':'Tüm personel çok sıcak ve yardımseverdi. Yemekler doyurucu ve lezzetliydi, konum denize çok yakın. Milli Park ve Zeus Mağarası kesinlikle görülmesi gereken yerler. Tekrar gelmek isterim.',
  'reviews.r4.text':'Deniz sakin ve temiz, odalar çok temiz ve geniş. Akşam yemekleri büfe şeklinde — özellikle akşamları ev yemeği tadında, gerçekten lezzetliydi.',
  'reviews.r5.text':'Sakin müzik ve personelle güzel bir atmosfer. Odalar modern ve uygun fiyata temiz. Denize iskele merdivenlerinden ulaşılıyor — sığ ve çocuklar için güvenli. En az 10 km\'lik plaj yürüyüş yolu ve bisiklet güzergahı var.',
  'reviews.r6.text':'Geçen yıl çok beğenip bu yıl tekrar geldik ve bir hafta kaldık. Huzurlu, ailece tatil yapabileceğiniz bir yer. Tekne turu ve iskele harika. Mutfak ekibine ve tüm personele çok teşekkürler.',
