/* Medos Hotel — i18n.en.js  (English translation strings) */
window._T_en = {
  ...
  'reviews.r1.text': 'Medos Hotel is in a perfect location. The rooms are very clean, the staff is attentive and the Iskele Cafe is especially magnificent at sunset. I didn\'t want to leave. Thank you very much for everything, Medos Hotel.',
  'reviews.source': 'TripAdvisor',
  'reviews.r2.text': 'The staff were so attentive — they upgraded my room to one with a full sea view. The hotel has a lovely pool area with sun beds and a bar. Breakfast was Turkish style, with plenty of options. I would certainly come back.',
  'reviews.r3.text':'All the staff were warm and attentive, the food was hearty and delicious. The location is very close to the sea. The National Park and Zeus Cave are great places to see. I would love to go back.',
  'reviews.r4.text':'The sea is very calm and clean, rooms are very clean and spacious. Dinners are buffet style — especially delicious in the evening, tasting just like home cooking.',
  'reviews.r5.text':'Beautiful views and a calming atmosphere. Rooms are modern, clean and affordable. Sea access via dock stairs — shallow and safe for children. Very long beachside pathways and bike lanes of at least 10 km.',
  'reviews.r6.text':'We loved it so much last year that we came back and stayed for a week. A peaceful place for a family vacation. The boat tour and pier are wonderful. Many thanks to the kitchen team and all the staff.',
  ...
  'hero.title': 'Sea sounds,<br>nature\'s embrace',
  'hero.title2': 'Book early,<br>save up to 25%',
  ...
  'blog.plaj.date': 'April 20, 2026',
  'blog.plaj.category': 'Beach Guide',
  'blog.plaj.excerpt': 'Güzelçamlı beaches: Sevgi Beach, Dilek Peninsula coves and coastal information. A guide for a peaceful seaside holiday with clean water and a calm atmosphere.',
  'blog.plaj.cta': 'Medos Beach Hotel is an ideal accommodation for easy access to Sevgi Beach and the nearby coves.',
  'blog.plaj.body': '<p>Among Güzelçamlı\'s beaches, Sevgi Beach, the coves within <a href="dilek_yarim_adasi_milli_park.html">Dilek Peninsula National Park</a> and the Güzelçamlı coastline stand out. With its clean sea, calm atmosphere and nature-immersed setting, the area is a strong alternative for those seeking a peaceful seaside holiday. Guests staying at <a href="index.html">Medos Hotel</a> can easily reach all of these beaches.</p><h2>Places to swim in Güzelçamlı</h2><p>Güzelçamlı, with its calm atmosphere and clean sea, is one of the ideal areas around Kuşadası for those seeking a peaceful beach holiday. It offers a holiday experience close to nature, away from crowded beach environments. These qualities are a great advantage for those looking for <a href="guzelcamli-otel.html">accommodation in Güzelçamlı</a>.</p><h2>Sevgi Beach</h2><img src="img/sevgi-plaji-guzelcamli.webp" alt="Güzelçamlı Sevgi Beach coastal view" loading="lazy" width="1200" height="800"><p>Sevgi Beach, with its wide beach area, shaded spots and family-friendly atmosphere, is one of Güzelçamlı\'s most popular beaches. Offering a comfortable environment for both families with children and couples, the beach provides a calmer experience in the morning hours.</p><h2>Dilek Peninsula National Park Beaches</h2><img src="img/dilek-yarimadasi-koy.webp" alt="Dilek Peninsula coves and clear sea" loading="lazy" width="1200" height="800"><p>Locations such as Aydınlık, Karasu and İçmeler within the national park offer a more natural and clearer sea experience amid nature. These coves attract particular attention for their clean water and natural appearance; they are very popular in summer. Visiting early in the morning ensures a more comfortable experience.</p><h2>Güzelçamlı Coastline</h2><img src="img/guzelcamli-sahil.webp" alt="Güzelçamlı coastline general view" loading="lazy" width="1200" height="800"><p>The Güzelçamlı coastline, close to the centre and ideal for daily sea enjoyment, appeals to holidaymakers of all ages. For those looking for <a href="kusadasi-denize-sifir-otel.html">beachfront accommodation</a>, the area is a very strong option.</p><h2>Hidden coves by boat tour</h2><img src="img/guzelcamli-tekne-turu-koy.webp" alt="Cove reached by Güzelçamlı boat tour" loading="lazy" width="1200" height="800"><p>With boat tours departing from Güzelçamlı, it is possible to reach coves that are difficult to access by land. These tours are an enjoyable activity that enriches the holiday for both families with children and couples. For detailed information, you can check the <a href="kusadasi-tekne-turlari-rehberi.html">Kuşadası Boat Tours Guide</a>.</p><h2>Why are Güzelçamlı beaches preferred?</h2><p>With its clean sea, calm atmosphere, family-friendly character and nature-immersed location, Güzelçamlı beaches offer a strong alternative to crowded holiday resorts. They are particularly ideal for those seeking a peaceful and quality seaside holiday.</p><h2>Frequently Asked Questions</h2><p><strong>Which is the most beautiful beach in Güzelçamlı?</strong><br>Sevgi Beach and the coves within the national park are among the most preferred options.</p><p><strong>Is Sevgi Beach suitable for families?</strong><br>Yes, it is a very suitable option for families due to its shaded areas and comfortable setting.</p>',
  'blog.efes.title': 'Ephesus Ancient City Visit Guide',
  'blog.efes.date': 'April 20, 2026',
  'blog.efes.category': 'History Guide',
  'blog.efes.excerpt': 'Ephesus guide: Library of Celsus, ancient theatre, marble street and how to get there from Kuşadası. Day trip tips from Güzelçamlı.',
  'blog.efes.cta': 'Combine your Ephesus visit with sea and relaxation — Medos Beach Hotel offers an ideal stay in Güzelçamlı.',
  'blog.efes.body': '<p>Ephesus Ancient City, with its proximity to Kuşadası, the Library of Celsus, ancient theatre and marble streets, is one of Turkey\'s most impressive historical destinations. Staying at <a href="index.html">Medos Hotel</a>, you can enjoy the tranquillity of Güzelçamlı while easily visiting Ephesus as a day trip.</p><h2>Where is Ephesus Ancient City?</h2><p>Ephesus is located in the Selçuk district, approximately 30 km from <a href="guzelcamli-otel.html">Güzelçamlı</a> and Kuşadası. This distance is very manageable for a day trip, either by private vehicle or organised tour.</p><h2>How to get to Ephesus?</h2><p>From Kuşadası and Güzelçamlı, you can reach Ephesus by private car in about 30 minutes, join organised day tours departing from the area, or plan your own route. For guests at a <a href="kusadasi-denize-sifir-otel.html">beachfront hotel in Kuşadası</a>, both options are very convenient.</p><h2>Library of Celsus</h2><img src="img/efes-celsus-kutuphanesi.webp" alt="Ephesus Library of Celsus facade" loading="lazy" width="1200" height="800"><p>The Library of Celsus, the most iconic structure of Ephesus, dates from the Roman period and is counted among the best-preserved ancient buildings in the world. A must-see during any visit, it also offers an exceptional opportunity for photography enthusiasts.</p><h2>Ancient Theatre</h2><img src="img/efes-antik-tiyatro.webp" alt="Ephesus Ancient Theatre general view" loading="lazy" width="1200" height="800"><p>With a capacity of approximately 25,000 people, the ancient theatre is one of the structures that best conveys the grandeur of Ephesus. Looking out from the theatre, it is possible to appreciate the overall layout of the ancient city.</p><h2>Marble Street</h2><img src="img/efes-mermer-cadde.webp" alt="Ephesus Ancient City marble street" loading="lazy" width="1200" height="800"><p>The Marble Street, one of the areas that best reflects the atmosphere of Ephesus, was one of the main arteries of the ancient city. Walking along it, you can sense two thousand years of history. Early mornings see fewer crowds and offer far better light for photography.</p><h2>How long does an Ephesus visit take?</h2><p>An average of 2–3 hours is sufficient for a comfortable visit to Ephesus. For a more detailed tour, we recommend arriving early in the morning and considering a guided tour option.</p><h2>Best time to visit Ephesus</h2><p>In summer, early morning hours are the ideal time both to avoid crowds and for photography. Spring and autumn months offer milder weather conditions, making them even more suitable for sightseeing.</p><h2>Why stay in Güzelçamlı for Ephesus?</h2><p>For those who want to combine an Ephesus visit with a beach holiday, <a href="guzelcamli-otel.html">Medos Hotel in Güzelçamlı</a> is an ideal choice. Easy access to Ephesus combined with proximity to <a href="dilek_yarim_adasi_milli_park.html">Dilek Peninsula National Park</a> makes our hotel one of the most well-rounded accommodation options in the region.</p><h2>Frequently Asked Questions</h2><p><strong>How long does it take to visit Ephesus?</strong><br>An average of 2–3 hours is sufficient. A more comprehensive visit may take up to 4 hours.</p><p><strong>Is it easy to get to Ephesus from Kuşadası?</strong><br>Yes, it is approximately 30 km away and very suitable for a day trip by private vehicle or tour.</p>',
